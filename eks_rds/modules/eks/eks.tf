resource "aws_cloudwatch_log_group" "eks_cluster_cw" {
...
resource "aws_eks_cluster" "eks_cluster" {
  ...
  depends_on = [aws_cloudwatch_log_group.eks_cluster_cw]
  ...
  vpc_config {
    ...
    public_access_cidrs = var.cidrs_cluster_access
  }
}

resource "aws_iam_role" "eks_cluster_role" {
  name = "${var.cluster_name}-default-role"
...
resource "aws_eks_node_group" "eks_nodegoup" {
...
resource "aws_iam_policy" "autoscaler_policy" {
  ...
  description = "${var.cluster_name} policy to enable cluster autoscale deployment"
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
        {
...
resource "aws_iam_role" "eks_ng_role" {
  name = "${var.nodegroup_name}-default-role"
...
resource "aws_iam_policy" "alb_policy" {
  name        = "${var.cluster_name}_cluster_alb_policy"
  description = "${var.cluster_name} policy to enable ALB deployment"
  policy = jsonencode({
    "Version": "2012-10-17",
    "Statement": [
        {
...
resource "aws_iam_role_policy_attachment" "attach-autoscaler-policy" {
